...
Comprehensive Windows Server health and performance collector. It samples CPU, memory, disk, and network counters, then adds Windows health, security, SQL Server, Hyper-V, and certificate checks. Output is a self-contained HTML report plus a CSV export.
...
HTML reports are stamped **Anthony Blake** / [Anthony.Blake@cdw.com](mailto:Anthony.Blake@cdw.com).
